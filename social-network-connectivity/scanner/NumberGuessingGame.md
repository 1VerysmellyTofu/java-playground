...
1. We provide two numbers as commandline arguments, say `A` and `B`
2. Our program selects a number `X` in the closed range [`A`, `B`].
3. We input a random (from stdin), and:
